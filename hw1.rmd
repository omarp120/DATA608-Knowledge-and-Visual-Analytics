...
Next, we remove outliers and then calculate the average number of employees by industry for these NY companies. 
...
Lastly, we graph these industry averages. It seems like Financial Services and Energy have, on average, more employees amongst NY's fast growth companies.
